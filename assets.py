...
METEOR_IMG = 'meteor_img'
PURPLE_METEOR_IMG = 'purple_meteor_img'
SHIP_IMG = 'ship_img'
SHIP_IMG = 'ship_img'
...
def load_assets():
    ...
    assets[PURPLE_METEOR_IMG] = pygame.image.load(os.path.join(IMG_DIR, 'meteorPurple_med1.png')).convert_alpha()
    assets[PURPLE_METEOR_IMG] = pygame.transform.scale(assets['purple_meteor_img'], (METEOR_WIDTH, METEOR_HEIGHT))
